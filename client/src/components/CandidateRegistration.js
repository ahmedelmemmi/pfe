          ...
          <div className="col-md-6 mt-5 mx-auto">
            <form noValidate onSubmit={this.onSubmit}>
              ...
              <div className="form-group">
                <label htmlFor="name">candidate_name</label>
                <input
                  type="text"
              ...
              <div className="form-group">
                <label htmlFor="name">candidate_service</label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="form-group">
                <label htmlFor="name">candidate_gender</label>
                <input
                  type="text"
                  className="form-control"
                  name="candidate_gender"
                  placeholder="mra wala  mch rajel"
                  value={this.state.candidate_gender}
                  onChange={this.onChange}
                />
              </div>
              <div className="form-group">
                <label htmlFor="name">candidate_nb_experience</label>
                <input
                  type=""
                  className="form-control"
              ...
              <div className="form-group">
                <label htmlFor="name">candidate_adress</label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="form-group">
                <label htmlFor="name">candidate_city</label>
                <input
                  type="text"
                  className="form-control"
                  name="candidate_city"
